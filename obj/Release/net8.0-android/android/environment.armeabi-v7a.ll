...
@dso_cache = dso_local local_unnamed_addr global [658 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 41648429, ; hash 0x27b812d, from name: libaot-MovieAppHHRU.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 471532620, ; hash 0x1c1b044c, from name: aot-MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	...
	%struct.DSOCacheEntry {
		i64 1090615281, ; hash 0x410177f1, from name: MovieAppHHRU.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	...
	%struct.DSOCacheEntry {
		i64 3472786136, ; hash 0xcefe82d8, from name: libaot-MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 530
	...
	%struct.DSOCacheEntry {
		i64 3626707018, ; hash 0xd82b284a, from name: MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 551
	...
	%struct.DSOCacheEntry {
		i64 3708901897, ; hash 0xdd115a09, from name: aot-MovieAppHHRU.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 572
