...
@dso_cache = dso_local local_unnamed_addr global [658 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2168427057209589442, ; hash 0x1e17cceb7252bec2, from name: aot-MovieAppHHRU.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 67
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Runtime.Serialization.Formatters.dll.so
		ptr null; void* handle (0x0)
	}, ; 106
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5993828338259497289, ; hash 0x532e5b1df2a09149, from name: MovieAppHHRU.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.81_name, ; name: libaot-System.Linq.Queryable.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7866237434574103060, ; hash 0x6d2a7d4506ab6214, from name: aot-MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 270
	...
	%struct.DSOCacheEntry {
		i64 7906140706387110155, ; hash 0x6db841157c75a90b, from name: MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 272
	...
	%struct.DSOCacheEntry {
		i64 8140685994947354009, ; hash 0x70f986c7fcd59d99, from name: libaot-MovieAppHHRU.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 282
	...
	%struct.DSOCacheEntry {
		i64 9786712514487239458, ; hash 0x87d1632e00e1c322, from name: libaot-MovieAppHHRU
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MovieAppHHRU.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
...
@.env.3 = private unnamed_addr constant [37 x i8] c"9585cbb4-4fdc-4ca4-8bb0-c5c956b265c8\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.movieapphhru\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-MovieAppHHRU.dll.so\00", align 16
...
@.DSOCacheEntry.81_name = private unnamed_addr constant [36 x i8] c"libaot-System.Linq.Queryable.dll.so\00", align 16
...
@.DSOCacheEntry.92_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 16
...
@.DSOCacheEntry.96_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 16
